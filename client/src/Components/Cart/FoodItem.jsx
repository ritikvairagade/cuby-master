    ...
    return (
        ...
        <div className="flex items-center gap-2">
          <div className="flex flex-col items-end">
            ...
            <div className="px-1 bg-cuby-400 text-white rounded flex items-center gap-1">
              <button
                onClick={decrement}
                className="p-1 bg-cuby-400 text-white rounded"
              >
                -
              </button>
          ...
          <BsTrashFill
            ...
            className="text-cuby-400 text-lg md:text-xl  "
          />
        </div>
      </div>
      <hr className="my-1" />

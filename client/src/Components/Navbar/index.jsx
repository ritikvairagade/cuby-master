  ...
  return (
    <div className="flex w-full items-center justify-between lg:hidden">
      ...
      <div className="flex items-center gap-3">
        <button className="bg-cuby-400 text-white py-2 px-3 rounded-full">
          Use App
        </button>
        <span className="border p-2 border-gray-300 text-cuby-400 rounded-full">
          <FaUserAlt />
        </span>
      </div>
    </div>

           ...
           <div className="flex items-start gap-2 ">
            {food?.image && (
             <div className="w-3/12 h-24 md:h-28 lg:h-36  md:px-3">
               ...
               <div className="w-3/4 md:w-7/12 flex flex-col gap-1">
                   <div className="flex items-center justify-between">
                       ...
                       <button
                          ...
                          className=" md:hidden flex items-center gap-2 text-cuby-400 bg-cuby-50 border border-cuby-400 px-2 py-1 rounded-lg"
                        >
                        {food.isAddedToCart ? (
                            "Added"
                        ) : (
              ...
              onClick={addFoodToCart}
              disabled={food.isAddedToCart}
              className=" flex items-center gap-2 text-cuby-400 bg-cuby-50 border border-cuby-400 px-4 py-2 rounded-lg"
            >
              {food.isAddedToCart ? (
                "Added"
              ) : (
